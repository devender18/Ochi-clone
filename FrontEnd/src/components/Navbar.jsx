export default function Navbar() {
  return (
    <div className=" fixed z-[999] w-full">
      <div className="flex justify-between items-center mx-8 my-8 font-['Neue_Montreal'] ">
        <div>
          <svg
        ...
        <div className="flex gap-10 font">
          {["Services", "Our work", "About us", "Insights"].map(
            (item, index) => {
              return (
                <a key={index} className="text-lg font-semibold cursor-pointer ">
                  {item}
                </a>
              );
            }
        ...
        <div>
          <p className="text-lg font-semibold cursor-pointer">Contact us</p>
        </div>
      </div>
    </div>
  );
